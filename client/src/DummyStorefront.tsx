...
const products = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1517816743773-6e0fd518b4a6?auto=format&fit=crop&w=400&q=80', // Solar panel
  },
  {
    ...
    price: '₦520,000',
    image: 'https://images.unsplash.com/photo-1581091012184-7b8c1ec7c7a7?auto=format&fit=crop&w=400&q=80', // Inverter
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1518987048-5ca211f1b9b7?auto=format&fit=crop&w=400&q=80', // Lithium battery
  },
  {
    name: 'SolarGlow 80W Street Light',
    description: 'All-in-one solar street light with motion sensor and long-lasting LED.',
    price: '₦120,000',
    image: 'https://images.unsplash.com/photo-1509228468518-180dd4864904?auto=format&fit=crop&w=400&q=80', // Street light
  },
  {
    name: 'PowerMax 150A MPPT Controller',
    description: 'Smart MPPT charge controller for optimal solar power management.',
    price: '₦250,000',
    image: 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=400&q=80', // MPPT controller
  },
];
