...
const DummyStorefront: React.FC = () => {
  ...
  return (
    <div className="dummy-storefront">
      ...
      <nav className="top-nav" style={{width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 32px', background: 'linear-gradient(90deg, #e0ffe7 0%, #f7f7f7 100%)'}}>
      ...
      <section className="hero-section">
        <h1>Bright Power, Brighter Future</h1>
        <p>Affordable, sustainable energy designed for every home and business.</p>
